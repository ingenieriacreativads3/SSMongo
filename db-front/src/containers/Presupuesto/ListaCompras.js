...
class ListaPresupuestosCompras extends React.Component {
                    ...
                    <div class="col-xs-12">
                      <div class="box">
                        <div class="box-header">
                          <h3 class="box-title">Mis compras - Presupuestos</h3>
                        </div>
...
export default connect(mapStateToProps)(ListaPresupuestosCompras);